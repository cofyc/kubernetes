...
// predicateMap stores resultMaps with predicate order ID as the key.
...
func (n *NodeCache) RunPredicate(
	...
	if cache != nil {
		n.updateResult(pod.GetName(), predicateKey, predicateID, fit, reasons, equivClass.hash, cache, nodeInfo)
	}
